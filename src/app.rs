use eframe::egui::{self, Button, Color32, Frame, Label, Layout, ScrollArea, Theme, Ui};
...
impl App {
    ...
    const COL_GREY10: Color32 = Color32::from_rgb(0xF8, 0xF8, 0xF8); //::from_hex("#eee").expect("Grey10 is invalid");
